...
CREATE TABLE users (id VARCHAR(64) PRIMARY KEY, name VARCHAR(256), email VARCHAR(256), username VARCHAR(64), password VARCHAR(64), is_admin BOOLEAN, totp_secret VARCHAR(32), UNIQUE (email), UNIQUE (username));
